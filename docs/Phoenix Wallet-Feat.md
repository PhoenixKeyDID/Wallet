...
- [partial] **Send + staking** verified end-to-end on preprod (send ADA, mint + send a native token, delegate to a stake pool). Governance dRep register/vote fee needs one preprod submit to confirm the witness count before mainnet enable.
